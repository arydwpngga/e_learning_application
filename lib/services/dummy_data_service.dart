...
class DummyDataService {
  static final List<Course> courses = [
    ...
    Course(
      id: '4',
      title: 'Advance Mobile App Architecture',
      description:
          'Learn advance architectural patterns and best practices for mobile app development.',
      imageUrl:
    ...
    Course(
      ...
      level: 'Intermediate',
      requirements: [
        'Basic Adobe After Effect Knowledge',
    ...
    Course(
      id: '6',
      title: 'Financial Management Fundamental',
      description:
  ...
  static final List<Quiz> quizzes = [
    ...
    Quiz(
      ...
      timeLimit: 20,
      questions: _createStateManagementQuizQuestion(),
  ...
  static List<Lesson> _createArchitectureLessons() {
    return [
      ...
      _createLesson('4', 'Depedency Injection', false, false),
  ...
  static List<Resource> _createDummyResources() {
    return [
      ...
      Resource(
        ...
        type: 'zip',
        url: 'https://example.com/exercise.zip',
      ),
    ];
  }
  ...
  static bool isCourseCompleted(String courseId) {
    ...
    return course.lessons.every((lesson) => lesson.isComplete);
  }
  ...
  static List<Question> _createStateManagementQuizQuestion() {
    return [
      Question(
        id: '1',
        ...
        options: [
          ...
          Option(id: 'd', text: 'Managing network request'),
        ],
        correctOptionId: 'a',
        points: 1,
      ),
  ...
  static final Map<String, List<StudentProgress>> studentProgress = {
    'inst_1': [
      StudentProgress(
        studentId: 'student_1',
        studentName: 'Arya Dwi Pangga Handoko',
        courseId: '1',
    ...
    if (courseIndex != -1) {
      ...
      if (lessonIndex != -1) {
        var updatedLesson = course.lessons[lessonIndex].copyWith(
          isComplete: isComplete ?? course.lessons[lessonIndex].isComplete,
